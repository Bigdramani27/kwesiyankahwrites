                            ...
                            <li
                              ...
                              <ul class="sub-menu">
                                <li
                                  ...
                                  <a href="../categories/index.php"><span class="menu-title">Sole-Authored Books</span></a>
                                </li>
                                <li
                                  id="menu-item-6157"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6157">
                                  <a
                                    href="../categories/index.php"><span class="menu-title">Monographs</span></a>
                                </li>
                                <li
                                  id="menu-item-3154"
                                  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3154">
                                  <a href="../categories/index.php"><span class="menu-title">Edited Volumes</span></a>
                                </li>
                                <li
                                  id="menu-item-3156"
                                  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3156">
                                  <a href="../categories/index.php"><span class="menu-title">On the Author’s Work</span></a>
                                </li>
                                <li
                                  id="menu-item-6218"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6218">
                                  <a href="../categories/index.php"><span class="menu-title">Book Chapters
                                    </span></a>
                                </li>
                                <li
                                  id="menu-item-6218"
                                  class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6218">
                                  <a href="../categories/index.phpl"><span class="menu-title">Journal Articles
                                    </span></a>
                                </li>
                              </ul>
                            </li>
            ...
            <div
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">Genre</div>
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i><a href="">Genre <i class="bookory-icon-right-arrow"></i></a><?php echo $genre ?>
                    </nav>
                  </div>
                </div>
              </div>
          ...
          <main id="main" class="site-main" role="main">
            ...
            <div class="bookory-products-overflow">
              <ul class="bookory-products products columns-3">
                <?php $products = select_all_product_genre_controller($genre, $start_from, $num_per_page);
            ...
            <nav class="woocommerce-pagination">
              <?php
              $total_record = count_all_product_genre_controller($genre);
              ...
              <ul class="page-numbers">
                <?php if ($page > 1) { ?>
                  <li>
                    <a class="prev page-numbers" href="?genre=<?php echo $genre ?>&page=<?php echo $page - 1; ?>"><i class="bookory-icon bookory-icon-angle-left"></i><span>Previous</span></a>
                  </li>
                <?php } ?>
                ...
                <?php for ($i = $pagination_start; $i <= $pagination_end; $i++) { ?>
                  ...
                  <?php } else { ?>
                    <li><a aria-label="Page 1" class="page-numbers" href="?genre=<?php echo $genre ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php } ?>
                <?php } ?>
                <?php if ($page < $total_page) { ?>

                  <li><a class="next page-numbers" href="?genre=<?php echo $genre ?>&page=<?php echo $page + 1; ?>"><span>Next</span><i class="bookory-icon bookory-icon-angle-right"></i></a></li>
                <?php } ?>
        ...
        <div id="secondary" class="widget-area" role="complementary">
          ...
          <div
            ...
            <ul class="woocommerce-widget-layered-nav-list">
              <li
                class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo ($genre === 'Academics') ? 'current-cat' : ''; ?>">
                <a
                  rel="nofollow"
                  href="../genre/index.php?genre=<?php echo urlencode('Academics'); ?>">Academics</a>
              </li>
              <li
                class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo ($genre === 'Media') ? 'current-cat' : ''; ?>">
                <a
                  rel="nofollow"
                  href="../genre/index.php?genre=<?php echo urlencode('Media'); ?>">Media</a>
              </li>
              <li
                class="woocommerce-widget-layered-nav-list__item wc-layered-nav-term <?php echo ($genre === 'Edited Works') ? 'current-cat' : ''; ?>">
                <a
                  rel="nofollow"
