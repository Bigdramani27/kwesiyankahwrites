            ...
            <div class="error-404 not-found">
              <div class="page-content">
                ...
                <div class="error-text">
                  <span>It looks like nothing was found at this location. You can
                    either go back to the last page or go to homepage.</span>
                </div>
                <div class="error-btn">
                  <a
