...
<head>
  ...
  <title>KwesiYankahWrites - Dashboard</title>
  <link
    rel="stylesheet"
    id="dashicons-css"
...
<body
  class="page-template-default page page-id-10 logged-in wp-custom-logo wp-embed-responsive theme-bookory woocommerce-account woocommerce-page woocommerce-view-order woocommerce-js ehf-header ehf-footer ehf-template-bookory ehf-stylesheet-demo-child woo-variation-swatches wvs-behavior-blur wvs-theme-demo-child wvs-show-label wvs-tooltip group-blog woocommerce-active product-block-style-1 elementor-default elementor-kit-4 dokan-theme-bookory has-scrollbar e--ua-blink e--ua-edge e--ua-webkit"
                            ...
                            <li
                              ...
                              <ul class="sub-menu">
                                ...
                                <li
                                  ...
                                  <a href="../categories/index.php"><span class="menu-title">Monographs</span></a>
                                </li>
                                <li
                                  id="menu-item-3154"
            ...
            <div
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">View All Books</div>
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i><a href="">Admin</a><i class="bookory-icon-right-arrow"></i>View All Books
                    </nav>
                  </div>
                </div>
              </div>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="#modalOverlay<?php echo $product['productID'] ?>" class="btn black">Delete</a>
                              </td>
                            </tr>
                          <?php } ?>
                        </tbody>
  ...
  <?php $products = select_all_products_controller();
  foreach ($products as $product) { ?>
    <div class="modal-overlay" id="modalOverlay<?php echo $product['productID'] ?>">
      <div class="modal">
        <span class="close-modal" onclick="closeModal()">&times;</span>
        <p>Do you want to delete <b><?php echo $product['productName'] ?></b> book?</p>
        <form id="delete-<?php echo $product['productID'] ?>">
          <input type="hidden" name="productID" value="<?php echo $product['productID'] ?>">
          <div class="modal-buttons">
            <button class="yes-btn" type="submit">Yes</button>
            <button class="no-btn" type="button">No</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    ...
    document.querySelectorAll('a.btn.black').forEach(link => {
    ...
    // Attach close logic to each modal
    document.querySelectorAll('.modal-overlay').forEach(modal => {
      ...
      // Close when clicking the close icon or "No" button
      modal.querySelectorAll('.close-modal, .no-btn').forEach(el => {
  ...
  <script>
    $(document).ready(function() {
      $('form[id^="delete-"]').submit(function(event) {
