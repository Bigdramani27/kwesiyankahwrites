...
<head>
  ...
  <title>Prof Kwesi Yankah Book Store - Requested Books</title>
  <link
    rel="stylesheet"
    id="dashicons-css"
            ...
            <div
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">Requested Books</div>
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i><a href="">Admin</a><i class="bookory-icon-right-arrow"></i>Requested Books
                    </nav>
                  </div>
                </div>
              </div>
                  ...
                  <div class="woocommerce-MyAccount-content">
                    ...
                    <div class="table-scroll">
                      <table class="responsive-table">
                        ...
                        <tbody>
                          <tr>
                            <td>Jacinta Badu Esi Amowah</td>
                            <td>+233 548342821 </td>
                            <td>Rich man and Poor Soon</td>
                            <td style="text-align: center;">12th May 2024</td>
                            <td>
