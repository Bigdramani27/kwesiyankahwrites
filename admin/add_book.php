...
<head>
  ...
  <title>Prof Kwesi Yankah Book Store - Dashboard</title>
  <link
    rel="stylesheet"
    id="dashicons-css"
            ...
            <div
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">Add a Book</div>
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i><a href="">Admin</a><i class="bookory-icon-right-arrow"></i>Add a Book
                    </nav>
                  </div>
                </div>
              </div>
                    ...
                    <form id="add_book"
                      ...
                      <p
                        ...
                        <select style="border-radius: 50px;"
                          required="true" name="productCategory">
                          <option disabled selected value="">Select category</option>
                          <option value="Sole-Authored Books"> Sole-Authored Books</option>
                          <option value="Monographs">Monographs</option>
                          <option value="Edited Volumes"> Edited Volumes</option>
                          <option value="n the Author’s Work"> On the Author’s Work</option>
                      ...
                      <p
                        ...
                        <select style="border-radius: 50px;"
                          required="true" name="productGenre">
                          <option disabled selected value="">Select genre</option>
                          <option value="Academics">Academics</option>
                          <option value="Media">Media</option>
                          <option value="Edited Works">Edited Works</option>
                        </select>
                      </p>
                      <div class="clear"></div>
                      ...
                      <p
                        ...
                        <select style="border-radius: 50px;"
                          required="true" name="productLanguage">
                      ...
                      <p
                        ...
                        <input
                          type="number"
                          class="woocommerce-Input woocommerce-Input--text input-text"
                          name="productAvailable" required />
                      </p>
                      <div class="clear"></div>
                      <p
                        class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                        ...
                        <input
                          type="file"
                          class="woocommerce-Input woocommerce-Input--text input-text"
                          accept="image/*" name="productImage" required />
                      </p>
                      <p
                        class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
                        ...
                        <input
                          type="file"
                          class="woocommerce-Input woocommerce-Input--text input-text" accept=".pdf" name="productFileLocation" required />
                      </p>
                      <div class="clear"></div>
                      <p
                        class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                        ...
                        <input
                          type="number"
                          class="woocommerce-Input woocommerce-Input--text input-text"
                          name="productWeight" required />
                      </p>
                      <p
                        class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        <label for="account_email">Book Description&nbsp;<span class="required">*</span></label>
                        <textarea name="productDescription" class="woocommerce-Input woocommerce-Input--email input-text" placeholder="Write here..." required></textarea>
                      </p>
  ...
  <script>
    $(document).ready(function() {
      $('#add_book').submit(function(event) {
        ...
        if (imageInput.files.length > 0 && imageInput.files[0].size > maxImageSize) {
          Swal.fire({
            icon: 'error',
