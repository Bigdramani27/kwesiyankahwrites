                ...
                <div
                  ...
                  <div class="elementor-widget-container">
                    ...
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i><a href="">My account</a><i class="bookory-icon-right-arrow"></i>Account details
                    </nav>
                  </div>
                </div>
              </div>
                  ...
                  <nav
                    ...
                    <ul>
                      <li
                        ...
                        <a href="index.php" aria-current="page"> Orders </a>
                      </li>
                      <li
                    ...
                    <form
                      ...
                      <p>
                        <input
                          ...
                          value="be78851973" /><input
                          type="hidden"
                          name="_wp_http_referer"
                          value="/bookory/my-account/edit-account/" />
                        <button
                          type="submit"
