                      ...
                      <div class="woocommerce-address-fields">
                        ...
                        <div class="woocommerce-address-fields__field-wrapper">
                          <p class="form-row form-row-first validate-required"
                            id="shipping_first_name_field" data-priority="10"><label
                              ...
                              class="woocommerce-input-wrapper"><input type="text"
                                ...
                                id="shipping_first_name" placeholder="" value="red"
                          ...
                          <p class="form-row form-row-last validate-required"
                            id="shipping_last_name_field" data-priority="20"><label
                              ...
                              class="woocommerce-input-wrapper"><input type="text"
                                ...
                                id="shipping_last_name" placeholder="" value="dsd"
                          ...
                          <p class="form-row address-field validate-required form-row-wide"
                            id="shipping_address_1_field" data-priority="50"><label
                              ...
                              class="woocommerce-input-wrapper"><input type="text"
                                ...
                                placeholder="House number and street name" value="2323"
                          ...
                          <p class="form-row address-field validate-required form-row-wide"
                            ...
                            <label for="shipping_city" class="">Town / City&nbsp;<abbr
                              ...
                              class="woocommerce-input-wrapper"><input type="text"
                                ...
                                id="shipping_city" placeholder="" value="dsfsdf"
                                aria-required="true"
                          ...
                          <p class="form-row address-field validate-required validate-state form-row-wide"
                            ...
                            <label for="shipping_state" class="">Region&nbsp;<abbr
                                class="required" title="required">*</abbr></label><span
                              class="woocommerce-input-wrapper"><select style="border-radius: 50px;"
                                name="shipping_state" id="shipping_state"
                                class="state_select select2-hidden-accessible"
                                aria-required="true" autocomplete="address-level1"
                                data-placeholder="Select an option…"
                                data-input-classes="" data-label="Region" tabindex="-1"
                                aria-hidden="true">
