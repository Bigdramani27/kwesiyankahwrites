            ...
            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9ef6efd"
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div class="elementor-element elementor-element-59103fb hidden-bookory-title-single-yes elementor-widget elementor-widget-bookory-woocommerce-breadcrumb"
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">Order received</div>
                    <nav class="woocommerce-breadcrumb"><a
                        href="../index.php">Home</a><i
                        class="bookory-icon-right-arrow"></i><a
                        href="">Checkout</a><i
                        class="bookory-icon-right-arrow"></i>Order received</nav>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="woocommerce-order">
                    ...
                    <ul
                      ...
                      <li class="woocommerce-order-overview__order order">
                        Order number: <strong>9107</strong>
                      </li>
                      ...
                      <li class="woocommerce-order-overview__email email">
                        Email: <strong>profkwesiyankah@gmail.com</strong>
                      </li>

                      <li class="woocommerce-order-overview__total total">
                        Total: <strong><span class="woocommerce-Price-amount amount"><bdi><span
                                class="woocommerce-Price-currencySymbol">$</span>1,142.00</bdi></span></strong>
                      </li>

                      <li class="woocommerce-order-overview__payment-method method">
                        Phone <strong>+233 548342821</strong>
                      </li>
                        ...
                        <tbody>
                          <tr class="woocommerce-table__line-item order_item">
                            ...
                            <td class="woocommerce-table__product-name product-name">
                              <a
                                href="https://demo2.pavothemes.com/bookory/product/annie-leibovitz-wonderland/">Annie
                                Leibovitz: Wonderland</a> <strong
                                class="product-quantity">×&nbsp;1</strong><br>Vendor: <a
                                href="https://demo2.pavothemes.com/bookory/store/barone/">Barone
                                LLC.</a>
                            </td>
                          ...
                          <tr class="woocommerce-table__line-item order_item">
                            ...
                            <td class="woocommerce-table__product-name product-name">
                              <a
                                ...
                                by Idiots</a> <strong
                                class="product-quantity">×&nbsp;1</strong><br>Vendor: <a
                                href="https://demo2.pavothemes.com/bookory/store/onlinestore/">Online
                                Store</a>
                            </td>

                            <td class="woocommerce-table__product-total product-total">
                              <span class="woocommerce-Price-amount amount"><bdi><span
                                    class="woocommerce-Price-currencySymbol">$</span>825.85</bdi></span>
                            </td>
                        ...
                        <tfoot>
                          <tr>
                            ...
                            <td><span class="woocommerce-Price-amount amount"><span
                                  class="woocommerce-Price-currencySymbol">$</span>1,142.00</span>
                            </td>
                          </tr>
                          <tr>
                    ...
                    <section class="woocommerce-customer-details">
                      ...
                      <address>
                        Dummy Test<br>2332<br>Test, CA 90001
                        <p class="woocommerce-customer-details--phone">343444434</p>

                        <p class="woocommerce-customer-details--email">profkwesiyankah@gmail.com
                        </p>
      ...
      <ul class="account-dashboard">
        ...
        <li>
          <a
            title=""
            class="tips"
            href="https://demo2.pavothemes.com/bookory/wp-login.php?action=logout&amp;redirect_to=https%3A%2F%2Fdemo2.pavothemes.com%2Fbookory&amp;_wpnonce=c2822ee156"
