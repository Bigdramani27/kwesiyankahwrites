                ...
                <div
                  ...
                  <div class="elementor-widget-container">
                    ...
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i>Shop
                    </nav>
                  </div>
                </div>
              </div>
          ...
          <main id="main" class="site-main" role="main">
            ...
            <div class="bookory-products-overflow">
              <ul class="bookory-products products columns-3">
                <?php $products = select_all_product($start_from, $num_per_page);
            ...
            <nav class="woocommerce-pagination">
              <?php
              $total_record = count_all_product_controller();
              ...
              <ul class="page-numbers">
                <?php if ($page > 1) { ?>
                  <li>
                    <a class="prev page-numbers" href="?page=<?php echo $page - 1; ?>"><i class="bookory-icon bookory-icon-angle-left"></i><span>Previous</span></a>
                  </li>
                <?php } ?>
                ...
                <?php for ($i = $pagination_start; $i <= $pagination_end; $i++) { ?>
                  ...
                  <?php } else { ?>
                    <li><a aria-label="Page 1" class="page-numbers" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php } ?>
                <?php } ?>
                <?php if ($page < $total_page) { ?>

                  <li><a class="next page-numbers" href="?page=<?php echo $page + 1; ?>"><span>Next</span><i class="bookory-icon bookory-icon-angle-right"></i></a></li>
                <?php } ?>
