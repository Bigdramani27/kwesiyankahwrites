...
<body
            ...
            <div
              ...
              <div class="elementor-widget-wrap elementor-element-populated">
                <div
                  ...
                  <div class="elementor-widget-container">
                    <div class="bookory-woocommerce-title">Wishlist</div>
                    <nav class="woocommerce-breadcrumb">
                      <a href="../index.php">Home</a><i class="bookory-icon-right-arrow"></i>Wishlist
                    </nav>
                  </div>
                </div>
              </div>
            ...
            <article
              ...
              <div class="entry-content">
                <div class="woosw-list">
                  <table class="woosw-items" data-key="WOOSW">
                    <?php $products = select_user_wishlist_controller($customer_id);
                    foreach ($products as $product) { ?>
                      <tr class="woosw-item woosw-item-111" data-id="111">
                        <td class="product-remove">
                          <a
                            href="../action/delete_wishlist.php?SKU=<?php echo $product['productID'] ?>"
                            class="remove"
                            style="
                              margin-right: auto;
                              margin-left: auto;
                        ...
                        <td class="woosw-item--image">
                          <a href="../product/index.php?SKU=<?php echo $product['productID'] ?>"><img
                              fetchpriority="high"
                              decoding="async"
                              width="600"
                              height="840"
                    ...
                    <?php }
                    if (empty($products)) {
                      echo "<h5 style='display:flex; justify-content:center'>Wishlist Is Empty</h5>";
                    }
                    ?>
                  </table>
                </div>
  ...
  <script>
    $(document).ready(function() {
      $('form[id^="cart-"]').submit(function(event) {
