...
<html lang="en-US">
  ...
  <head>
    ...
    <title>Lost password &#8211; Bookory</title>
  ...
  <body
    class="page-template-default page page-id-10 wp-custom-logo wp-embed-responsive theme-bookory woocommerce-account woocommerce-page woocommerce-lost-password woocommerce-no-js ehf-header ehf-footer ehf-template-bookory ehf-stylesheet-demo-child woo-variation-swatches wvs-behavior-blur wvs-theme-demo-child wvs-show-label wvs-tooltip group-blog woocommerce-active product-block-style-1 elementor-default elementor-kit-4 dokan-theme-bookory"
  >
                            ...
                            <ul id="menu-1-0041078" class="menu">
                              ...
                              >
                                <a href="../author/index.php"
                                  ><span class="menu-title">Author</span></a
                                >
                              </li>
                              <li
                                id="menu-item-2842"
            ...
            <div class="elementor-container elementor-column-gap-no">
              ...
              >
                <div class="elementor-widget-wrap elementor-element-populated">
                  ...
                  >
                    <div class="elementor-widget-container">
                      <div class="bookory-woocommerce-title">Lost password</div>
                      <nav class="woocommerce-breadcrumb">
                        <a href="../../index.php">Home</a
                        ><i class="bookory-icon-right-arrow"></i
                        ><a href="">My account</a
                        ><i class="bookory-icon-right-arrow"></i>Lost password
                      </nav>
                    </div>
                  </div>
                </div>
   ...
   <div class="bookory-mobile-nav">
    ...
    <script
      ...
      id="dokan-vendor-registration-js"
    ></script>
    <script
    ...
    <script
      ...
      id="bookory-elementor-frontend-js"
    ></script>
    <script
    ...
    <script
      ...
      id="bookory-elementor-sticky-js"
    ></script>
  </body>
